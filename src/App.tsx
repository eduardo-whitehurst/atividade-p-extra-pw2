  ...
  return (
	...
	<div className="flex flex-col items-start w-[589px] mt-[9px] mr-[138px]">
		...
		<div className="flex items-center self-stretch mb-[15px] mr-[63px]">
			<div className="flex flex-col bg-[#C47E16] w-[32px] pl-[8px] pr-[8px] mr-[12px] rounded-[1000px]">
				<img
					src={"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/9e3a395f-49fa-4409-a3f8-5563fbb5fb13"} 
			...
			<div className="flex flex-col bg-[#564F4C] w-[32px] pl-[8px] pr-[8px] mr-[13px] rounded-[1000px]">
				<img
					src={"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/caf2f314-48d2-4ab1-a099-933aab3f3c0b"} 
					className="self-stretch h-[16px] mt-[8px] object-fill"
				/>
			</div>
		...
		<div className="flex items-center self-stretch mr-[23px]">
			<div className="flex flex-col bg-[#DBAC2B] w-[32px] pl-[8px] pr-[8px] mr-[13px] rounded-[1000px]">
				<img
					src={"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d7622d12-f2eb-46d0-97a1-113b340a5c11"} 
					className="self-stretch h-[16px] mt-[8px] object-fill"
				/>
			</div>
			...
			<div className="flex flex-col bg-[#7F46F7] w-[32px] pl-[8px] pr-[8px] mr-[12px] rounded-[1000px]">
				<img
					src={"https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/cc316c65-2240-40eb-bf40-311ee4fd34bb"} 
					className="self-stretch h-[16px] mt-[8px] object-fill"
				/>
			</div>
			<span className="text-[#564F4C] text-[16px]" >
	...
	<img
		...
		className="w-[446px] h-[429px] rounded-[183px] object-fill"
	/>
</div>
  )
}
